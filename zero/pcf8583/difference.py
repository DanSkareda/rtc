...
# systémový čas v počítači s aktuálním časem v obvodu pcf8583 a zobrazuje rozdíl. Pro co nejpřesnější 
...
dtrtc = datetime(today.year, datum[1], datum[0], cas[0], cas[1], cas[2]) # složení dat z rtc do formátu systémového času
if dtrtc>today :
