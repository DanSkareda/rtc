...
# systémový čas v počítači s aktuálním časem v obvodu mcp794xx a zobrazuje rozdíl. Pro co nejpřesnější 
...
# rtc.calibration(0) # odkomentujte pro nastavení kalibrační konstanty, rozsah nastavení -127 až +127, případně 0-255
print("kalibrační konstanta: " + str(rtc.calibration())) # zobrazuje 0-255
